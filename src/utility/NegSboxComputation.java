/*
 * NegSboxComputation produces negation of original 8-bit S-box
 */
package utility;
 ...
 * @author hatasova
 */
public class NegSboxComputation {
       public final int dataToNegate[] = {
    ...
    public int negatedData[];

    public NegSboxComputation() {
        negatedData = new int[256];
    }
    
    public void createNegatedData() {
        for (int i = 0; i < dataToNegate.length; i++) {
            negatedData[i] = Integer.reverse(dataToNegate[i] << 24) & 0xff;
        }
    }
}
